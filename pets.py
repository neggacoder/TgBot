...
WALK_FINDS: dict[str, tuple[WalkFind, ...]] = {
    ...
    "kapibara": (WalkFind("привёз(ла) с купания сочный лист", "cvetok"),
                 WalkFind("нашёл(ла) у воды гладкий камешек", "kamen")),
    "koala":    (WalkFind("принёс(ла) эвкалиптовую веточку", "nitka"),
                 WalkFind("обнял(а) дерево и отыскал(а) на нём звезду", "zvezda")),
    "fenek":    (WalkFind("выкопал(а) в песке старую фишку", "fishka"),
                 WalkFind("услышал(а) под песком что-то блестящее", "ring")),
}
...
ABILITIES: tuple[Ability, ...] = (
    ...
    Ability("pet_feed",       "Заботливый",    "корм восстанавливает на {p}% больше сытости всем вашим питомцам", 30),
    Ability("pet_care",       "Ласковый",      "ласка даёт на {p}% больше настроения всем вашим питомцам", 30),
    Ability("pet_find",       "Искатель",      "шанс находки на прогулке у всех ваших питомцев выше на {p}%", 40),
)
...
EVOLUTIONS: dict[str, Evolution] = {
    ...
    "kapibara":   Evolution("Капибара-гуру", "🧘"),
    "koala":      Evolution("Коала-обнимала", "🌿"),
    "fenek":      Evolution("Песчаный дух", "🌪"),
}
...
PETS: tuple[Pet, ...] = (
    ...
    # --- забота о всей стае ---
    Pet("kapibara", "Капибара", "🦫", 38_000, "невозмутимо сидит в воде", "pet_feed"),
    Pet("koala",    "Коала",    "🐨", 42_000, "крепко обнимает ветку", "pet_care"),
    Pet("fenek",    "Фенек",    "🦊", 48_000, "навостряет огромные уши", "pet_find"),
...
ALIASES: dict[str, str] = {
    ...
    "капибара": "kapibara", "капиба": "kapibara",
    "коала": "koala", "коалёнок": "koala",
    "фенек": "fenek", "лисица фенек": "fenek",
